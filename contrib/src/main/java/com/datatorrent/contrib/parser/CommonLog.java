...
public class CommonLog implements Log
{
  ...
  //considering common log format ex : 125.125.125.125 - dsmith [10/Oct/1999:21:15:05 +0500] "GET /index.html HTTP/1.0" 200 1043
  private String pattern = "^([0-9.]+) ([a-zA-Z0-9_-]{1,16}) ([a-zA-Z0-9_-]{1,16}) \\[(.*?)\\] \"((?:[^\"]|\")+)\" (\\d{3}) (\\d+|-)";
  ...
  public Log getLog(String log) {
    ...
    if (m.find()) {
      ...
      DateTimeFormatter parser1 = DateTimeFormat.forPattern(dateFormat);
      DateTime dateTime = parser1.parseDateTime(m.group(4));
      if (dateTime != null) {
